...
from transformer import TransformerEncoder, TransformerEncoderLayer, _get_clones, _get_activation_fn
...
class BasePixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.in_features = [k for k, v in sorted_input_shape]  # starting from "res2" to "res5"
        ...
        self.maskformer_num_feature_levels = 4  # always use 3 scales
    ...
    def forward_features(self, features):
        ...
        # if y is None:
        #     raise ValueError("y was never assigned a value in forward_features.")
        # print("mask", self.mask_features(y).shape)
    ...
    def forward(self, features, targets=None):
        ...
        # 创建字典
        feature_dict = OrderedDict((name, features[i]) for i, name in enumerate(feature_names))
        # 打印结果
        ...
        return self.forward_features(feature_dict)
